...
public class HuffmanCode4String {
    ...
    public static void main(String[] args) {
        ...
        String str="nihao java scala spark and hadoop.";
        System.out.println("原长度："+str.getBytes().length); //33
        //1.压缩
        byte[] huffmanBytes = huffmanZip(str.getBytes());
        System.out.println("huffman压缩后长度：" + huffmanBytes.length); //15


        //2.解压缩
        byte[] decodeBytes = decode(huffmanCodes, huffmanBytes);
        System.out.println("原字符串："+ new String(decodeBytes));
    }
